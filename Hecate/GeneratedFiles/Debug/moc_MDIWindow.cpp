...
void MDIWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (MDIWindow::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MDIWindow::selectionChanged)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (MDIWindow::*_t)(const QString & , int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MDIWindow::message)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (MDIWindow::*_t)(MDIWindow * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MDIWindow::sendCloseView)) {
                *result = 2;
                return;
            }
        }
