...
public:
    ...
    virtual RibbonPage* insertPage(int index, const QString& text);
    virtual void insertPage(int index, RibbonPage* page);
    ...
    virtual void detachPage(int index);
...
public:
    QMenu* addMenu(const QIcon& icon, const QString& text, Qt::ToolButtonStyle style);
    ...
    QAction* addAction(QAction* action, Qt::ToolButtonStyle style, QToolButton::ToolButtonPopupMode popupMode);
