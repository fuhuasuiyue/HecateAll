...
QMenu *RibbonBar::addMenu(const QIcon &icon, const QString &text, Qt::ToolButtonStyle style)
{
    QTN_D(RibbonBar);
    return d.m_tabBar->addMenu(icon, text, style);
}
...
QAction *RibbonBar::addAction(QAction *action, Qt::ToolButtonStyle style, QToolButton::ToolButtonPopupMode popupMode)
{
    QTN_D(RibbonBar);
    QMenuBar::addAction(action);
    return d.m_tabBar->addAction(action, style, popupMode);
}
