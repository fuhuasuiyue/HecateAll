...
QAction *RibbonTabBar::addAction(QAction *action, Qt::ToolButtonStyle style, QToolButton::ToolButtonPopupMode popupMode)
{
    QTN_D(RibbonTabBar);
    if ( Qt::ToolButtonTextUnderIcon == style )
    {
...
{
    return addMenu(QIcon(), title, Qt::ToolButtonTextOnly);
}

QMenu *RibbonTabBar::addMenu(const QIcon &icon, const QString &title, Qt::ToolButtonStyle style)
{
    QTN_D(RibbonTabBar);
