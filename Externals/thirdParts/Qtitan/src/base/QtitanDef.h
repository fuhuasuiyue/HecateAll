...
#ifndef GLD_QTN_RIBBON_VER_CHECK
#   define GLD_QTN_RIBBON_VER_CHECK(x, y, z) ((z | (y << 8)) | (x << 16))
#endif

#define GLD_QTN_RIBBON_VERSION  GLD_QTN_RIBBON_VER_CHECK(3, 3, 0)

#define QTITAN_NAMESPACE Qtitan

#ifdef QTITAN_NAMESPACE
